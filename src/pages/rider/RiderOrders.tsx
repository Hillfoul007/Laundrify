  ...
  const getMockOrderData = (id: string) => {
    ...
    if (isQuickPickupDemo) {
      return {
        ...
        address_details: {
          flatNo: id === 'LAU-001' ? 'B-45' : 'A-45',
          street: id === 'LAU-001' ? 'Sector 28' : 'Sector 12',
          city: id === 'LAU-001' ? 'Gurugram' : 'Noida',
          pincode: id === 'LAU-001' ? '122002' : '201301',
          type: 'home'
        },
        pickupTime: id === 'LAU-001' ? '2:00 PM - 4:00 PM' : '3:00 PM - 5:00 PM',
        scheduled_date: new Date().toISOString().split('T')[0],
        scheduled_time: id === 'LAU-001' ? '14:00' : '15:00',
